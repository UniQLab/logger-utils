module.exports = {
	...
	LOG_INTO_FILE_CONFLICT: 'LogIntoFile is enabled, but no default directory is specified',
	KEYS_NOT_ARRAYS: 'Either of "FromKeys" or "toKeys" attributes are not arrays'
};
